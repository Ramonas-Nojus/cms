...
?>
    ...
    if(isset($_GET['v_id'])){
     ...
     ?> 
        <video class="vid" autoplay controls poster="<?php echo BASE_URL; ?>/images/<?php echo $video_image; ?>">
            <source src="<?php echo BASE_URL; ?>/all_videos/<?php echo $video_resources; ?>" type="video/mp4">
            <source src="<?php echo BASE_URL; ?>/all_videos/<?php echo $video_resources; ?>" type="video/ogg">
        ...
        <p class="lead">
            ...
            <a href="<?php echo BASE_URL; ?>/user_profile/<?php echo $video_author; ?>">
             <img  class="profilie_image" border-radius="50%" src="<?php echo BASE_URL; ?>/images/<?php if(empty($img->authorImage($video_author_id)['user_image'])){ echo "person-placeholder.jpg"; } else {  echo $img->authorImage($video_author_id)['user_image']; } ?>">
        ...
        <hr>
                ...
                if(UserLikedVideo($the_video_id)){  ?>
                        <div class="row">
                            <p class="pull-left"><a href="<?php echo BASE_URL; ?>/watch/<?php echo $the_video_id ?>" class="unlike"><span class="glyphicon glyphicon-thumbs-down"></span>Unlike</a></p>
                        </div>
                        <?php } else { ?>
                        <div class="row">
                            <p class="pull-left"><a href="<?php echo BASE_URL; ?>/watch/<?php echo $the_video_id ?>" class="like"><span class="glyphicon glyphicon-thumbs-up"></span>Like</a></p>
                        </div>
                         <?php }  } else { echo "<p class='pull-left'>You need to <a href='<?php echo BASE_URL; ?>/login'>Log In</a> to leave like</p>"; } ?>
                        <div class="row ">
                        <?php 
...
?> 
 ...
 <img class="media-object profilie_image" width="50px" border-radius="50%" src="<?php echo BASE_URL; ?>/images/<?php if(empty($img)){ echo "person-placeholder.jpg"; } else { echo $img; ?> " alt="">
                    </a>
                <?php } ?>
...
<script>
            $(document).ready(function(){
                ...
                $(".like").click(function(){
                   $.ajax({
                       url: "<?php echo BASE_URL; ?>/watch.php?v_id=<?php echo $the_video_id; ?>",
                       type: "post",
                       data: {
                           'liked': 1,
                           'video_id': video_id,
