           ...
           while($row = mysqli_fetch_array($get_request_query)){
            ...
            <form action="notifications.php" method="post">
               ...
               <?php 
                   ...
                   ?>
                   <div class="pull-left">
                   <img src="<?php echo BASE_URL; ?>/images/<?php echo $user_image; ?>">
                   </div>
                   <a href="<?php echo BASE_URL; ?>/user_profile/<?php echo $from_username; ?>"><?php  echo $from_username; ?></a> wants to be your friend</br>
